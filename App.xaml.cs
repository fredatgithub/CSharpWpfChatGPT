...
namespace CSharpWpfChatGPT
{
  public partial class App : Application
  {
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
      ...
      try
      {
        string openaiApiKey = App.ParseOpenAIApiKey(e.Args);
      ...
      {
        MessageBox.Show(exception.ToString(), "CSharpWpfChatGPT will exit on error");
        Current?.Shutdown();
      }
    }

    private static string ParseOpenAIApiKey(string[] args)
    {
      ...
      return "<Enter Your Open AI API Key here>";
    }
